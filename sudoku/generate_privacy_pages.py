...
PAGES = {
    "ko": {
        ...
        "intro": "넥스트 스튜디오는 Sudoku Pulse 이용자의 개인정보를 보호하고 관련 법령을 준수합니다.",
        "sections": [
            ("1. 수집 정보와 이용 목적", [
    ...
    "en": {
        ...
        "intro": "Next Studio protects the privacy of Sudoku Pulse users and complies with applicable privacy laws.",
        "sections": [
    ...
    "ja": {
        ...
        "intro": "Next Studioは、Sudoku Pulseの利用者のプライバシーを保護し、適用される法令を遵守します。",
        "sections": [
            ("1. 収集する情報と利用目的", [
    ...
    "zh-Hans": {
        ...
        "intro": "Next Studio致力于保护Sudoku Pulse用户的隐私，并遵守适用的隐私法律。",
        "sections": [
            ("1. 收集的信息及使用目的", [
    ...
    "es": {
        ...
        "intro": "Next Studio protege la privacidad de los usuarios de Sudoku Pulse y cumple las leyes de privacidad aplicables.",
        "sections": [
    ...
    "fr": {
        ...
        "intro": "Next Studio protège la vie privée des utilisateurs de Sudoku Pulse et respecte les lois applicables.",
        "sections": [
    ...
    "de": {
        ...
        "intro": "Next Studio schützt die Privatsphäre der Nutzer von Sudoku Pulse und beachtet die geltenden Datenschutzgesetze.",
        "sections": [
    ...
    "pt-BR": {
        ...
        "intro": "A Next Studio protege a privacidade dos usuários do Sudoku Pulse e cumpre as leis de privacidade aplicáveis.",
        "sections": [
...
STYLE = """
:root{color-scheme:light;--navy:#10243e;--blue:#2e6af3;--cloud:#f4f7fb;--line:#dbe4ef}
*{box-sizing:border-box}body{margin:0;background:linear-gradient(180deg,#eef4ff 0,#fff 360px);font:16px/1.75 system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--navy)}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}
...
<body><main><div class="top"><div class="brand">SUDOKU PULSE</div><label><span class="sr-only">Language</span><select class="language" aria-label="Language" onchange="location.href=this.value">{options}</select></label></div>
